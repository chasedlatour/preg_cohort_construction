...
create_figure(figure_data2 %>% 
              ...
              "Risk, Initiators", "0.7", "0.7")
create_figure(figure_data2%>% 
                filter(cohort != "Sens: Trt Pregnancies Outcome" & 
                         cohort != "Sens: Untrt Pregnancies Outcome"),
                       "Risk, Non-Initiators", "0.7", "0.7")
...
create_figure(figure_data2 %>% 
                filter(cohort != "Sens: Trt Pregnancies Outcome" & 
                         cohort != "Sens: Untrt Pregnancies Outcome"),
              "Risk, Initiators", "1", "0.7")
create_figure(figure_data2 %>% 
                filter(cohort != "Sens: Trt Pregnancies Outcome" & 
                         cohort != "Sens: Untrt Pregnancies Outcome"), 
              "Risk, Non-Initiators", "1", "0.7")
...
create_figure(figure_data2 %>% 
                filter(cohort != "Sens: Trt Pregnancies Outcome" & 
                         cohort != "Sens: Untrt Pregnancies Outcome"),
              "Risk, Initiators", "1.5", "0.7")
create_figure(figure_data2 %>% 
                filter(cohort != "Sens: Trt Pregnancies Outcome" & 
                         cohort != "Sens: Untrt Pregnancies Outcome"),
              "Risk, Non-Initiators", "1.5", "0.7")
...
create_figure(figure_data2 %>% 
                filter(cohort != "Sens: Trt Pregnancies Outcome" & 
                         cohort != "Sens: Untrt Pregnancies Outcome"),
              "Risk, Initiators", "0.7", "1")
create_figure(figure_data2 %>% 
                filter(cohort != "Sens: Trt Pregnancies Outcome" & 
                         cohort != "Sens: Untrt Pregnancies Outcome"),
              "Risk, Non-Initiators", "0.7", "1")
...
create_figure(figure_data2 %>% 
                filter(cohort != "Sens: Trt Pregnancies Outcome" & 
                         cohort != "Sens: Untrt Pregnancies Outcome"),
              "Risk, Initiators", "1.5", "1")
create_figure(figure_data2 %>% 
                filter(cohort != "Sens: Trt Pregnancies Outcome" & 
                         cohort != "Sens: Untrt Pregnancies Outcome"),
              "Risk, Non-Initiators", "1.5", "1")
