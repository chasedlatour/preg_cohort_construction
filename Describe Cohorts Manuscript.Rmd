...
print_analysis_kable_del <- function(data_subset){
  ...
  hold <- data_subset %>% 
    ...
    select(marginal_p_miss_severity, marginal_p_miss_miscarriage,
           truth_risk0, truth_risk1, truth_rd, truth_rr, truth_or,
           obs_del_risk0, obs_del_risk1, obs_del_rd, obs_del_rr, obs_del_or, 
...
print_analysis_kable_outc <- function(data_subset){
  ...
  hold <- data_subset %>% 
    ...
    select(marginal_p_miss_severity, marginal_p_miss_miscarriage,
           truth_risk0, truth_risk1, truth_rd, truth_rr, truth_or, 
           obs_out_risk0, obs_out_risk1, obs_out_rd, obs_out_rr, obs_out_or,
...
print_analysis_kable_all_outc <- function(data_subset){
  ...
  hold <- data_subset %>% 
    ...
    select(marginal_p_miss_severity, marginal_p_miss_miscarriage,
           truth_risk0, truth_risk1, truth_rd, truth_rr, truth_or,
           all_preg_all_outc_risk0, all_preg_all_outc_risk1, all_preg_all_outc_rd,
...
print_analysis_kable_untrt_outc <- function(data_subset){
  ...
  hold <- data_subset %>% 
    ...
    select(marginal_p_miss_severity, marginal_p_miss_miscarriage,
           truth_risk0, truth_risk1, truth_rd, truth_rr, truth_or,
           untrt_preg_outc_risk0, untrt_preg_outc_risk1, untrt_preg_outc_rd, 
...
print_analysis_kable_no_outc <- function(data_subset){
  ...
  hold <- data_subset %>% 
    ...
    select(marginal_p_miss_severity, marginal_p_miss_miscarriage,
           truth_risk0, truth_risk1, truth_rd, truth_rr, truth_or,
           all_preg_no_outc_risk0, all_preg_no_outc_risk1, all_preg_no_outc_rd,
