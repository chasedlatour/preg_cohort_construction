  ...
  plot <- dataset %>%
    ...
    facet_wrap(missing ~., nrow = 1, 
               labeller = labeller(missing = 
                                     c("0/0.05" = "Severity: 0%, Miscarriage: 5%",
                                       "0.025/0.025" = "Severity: 2.5%, Miscarriage: 2.5%",
                                       "0.05/0" = "Severity: 5%, Miscarriage: 0%",
                                       "0/0.2" = "Severity: 0%, Miscarriage: 20%",
                                       "0.1/0.1" = "Severity: 10%, Miscarriage: 10%",
                                       "0.2/0" = "Severity: 20%, Miscarriage: 0%"))) +
    geom_hline(aes(yintercept = 0), col = "black", linetype = "dashed") +
    # ggtitle(bquote(.(param) ~ ": " ~ RR[Abortion] == .(rr_abortion) ~ 
    #                " and " ~ RR[Preeclampsia] == .(rr_preeclampsia))) +
