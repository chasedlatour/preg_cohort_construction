...
create_biasfigure_nosens_supp <- function(dataset, parameter, rr_preec, title, y_min, y_max, parameter_yaxis = "Risk Difference (per 100)"){
...
pdf("Bias Risk by Missingness - Initiators - Decrease risk of Preeclampsia - No sensitivity analyses - 5pct.pdf",
    height = 2, width = 10)
create_biasfigure_nosens_supp(bias_figure_data2_5pct, 
              "Risk, Initiators", 
              "0.5",
              "(A) Risk, Initiators",
              y_min=-13, y_max = 13,
...
pdf("Bias Risk by Missingness difference - Decrease risk of Preeclampsia - No sensitivity analyses - 5pct.pdf",
    height = 2, width = 10)
create_biasfigure_nosens_supp(bias_figure_data2_5pct, "Risk Difference", "0.5",
                     "(C) Risk Difference", y_min=-6, y_max=6,
                     "Risk Difference (per 100)")
dev.off()

pdf("Bias Risk ratio by Missingness - Decrease risk of Preeclampsia - No sensitivity analyses - 5pct.pdf",
    height = 2, width = 10)
create_biasfigure_nosens_supp(bias_figure_data2_5pct, "Risk Ratio", "0.5",
                     "(D) Risk Ratio",
...
pdf("Bias Risk by Missingness - Initiators - Decrease risk of Preeclampsia - No sensitivity analyses - 20pct.pdf",
    height = 2, width = 10)
create_biasfigure_nosens_supp(bias_figure_data2_20pct, 
              "Risk, Initiators", 
              "0.5",
              "(A) Risk, Initiators",
              y_min=-15, y_max = 15,
...
pdf("Bias Risk difference by Missingness - No effect risk of Preeclampsia - No sensitivity analyses - 5pct.pdf",
    height = 2, width = 10)
create_biasfigure_nosens_supp(bias_figure_data2_5pct, "Risk Difference", 
                     "1", 
                     "(C) Risk Difference",
                     -20, 20,
                     "Risk Difference (per 100)")
...
create_biasfigure_nosens_supp(bias_figure_data2_5pct, "Risk Ratio", "1", 
                     "(D) Risk Ratio",
                     -0.75, 0.75,
